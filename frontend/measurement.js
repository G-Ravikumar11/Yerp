...
// The certified bill as the GST portal's e-invoice file, and the IRN and
// signed QR the portal gives back (einvoice.js).
function raEinvoice(id) { return einvoiceBox('ra_bill', id); }
